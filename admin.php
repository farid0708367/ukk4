...
if(isset($_POST['tambah'])){
    ...
    $sql = "INSERT INTO yaa(kode_buku, no_buku, judul_buku, tahun_terbit, penerbit, nama_penulis, jumlah_halaman, harga, gambar_buku)
...
<body>
    ...
    <table border="1">
        ...
        <?php
        $mysqli_query = mysqli_query($koneksi, "SELECT * FROM yaa");
